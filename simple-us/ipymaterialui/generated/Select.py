...
class Select(ReactWidget):
    ...
    auto_width = Bool(None, allow_none=True).tag(sync=True)
    ...
    display_empty = Bool(None, allow_none=True).tag(sync=True)
    ...
    Menu_props = Dict(default_value=None, allow_none=True).tag(sync=True)

    multiple = Bool(None, allow_none=True).tag(sync=True)

    native = Bool(None, allow_none=True).tag(sync=True)

    open_ = Bool(None, allow_none=True).tag(sync=True)

    Select_display_props = Dict(default_value=None, allow_none=True).tag(sync=True)
