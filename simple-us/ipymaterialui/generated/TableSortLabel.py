...
class TableSortLabel(ReactWidget):

    _model_name = Unicode('TableSortLabelModel').tag(sync=True)
    ...
    hide_sort_icon = Bool(None, allow_none=True).tag(sync=True)
