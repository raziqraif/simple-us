...
class ExpansionPanelSummary(ReactWidget):

    _model_name = Unicode('ExpansionPanelSummaryModel').tag(sync=True)
    ...
    Icon_button_props = Dict(default_value=None, allow_none=True).tag(sync=True)
