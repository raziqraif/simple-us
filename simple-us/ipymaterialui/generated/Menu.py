...
class Menu(ReactWidget):
    ...
    disable_auto_focus_item = Bool(None, allow_none=True).tag(sync=True)

    Menu_list_props = Dict(default_value=None, allow_none=True).tag(sync=True)

    open_ = Bool(None, allow_none=True).tag(sync=True)

    Paper_props = Dict(default_value=None, allow_none=True).tag(sync=True)

    Popover_classes = Dict(default_value=None, allow_none=True).tag(sync=True)
