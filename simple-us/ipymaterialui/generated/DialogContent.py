...
class DialogContent(ReactWidget):

    _model_name = Unicode('DialogContentModel').tag(sync=True)
    ...
    dividers = Bool(None, allow_none=True).tag(sync=True)


__all__ = ['DialogContent']
