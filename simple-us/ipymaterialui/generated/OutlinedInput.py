...
class OutlinedInput(ReactWidget):

    _model_name = Unicode('OutlinedInputModel').tag(sync=True)
    ...
    label_width = Float(None, allow_none=True).tag(sync=True)
    ...
    notched = Bool(None, allow_none=True).tag(sync=True)
