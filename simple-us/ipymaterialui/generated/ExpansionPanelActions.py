...
class ExpansionPanelActions(ReactWidget):

    _model_name = Unicode('ExpansionPanelActionsModel').tag(sync=True)
    ...
    disable_spacing = Bool(None, allow_none=True).tag(sync=True)


__all__ = ['ExpansionPanelActions']
