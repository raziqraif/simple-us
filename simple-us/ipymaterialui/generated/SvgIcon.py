...
class SvgIcon(ReactWidget):
    ...
    html_color = Unicode(None, allow_none=True).tag(sync=True)

    shape_rendering = Unicode(None, allow_none=True).tag(sync=True)

    title_access = Unicode(None, allow_none=True).tag(sync=True)

    view_box = Unicode(None, allow_none=True).tag(sync=True)
