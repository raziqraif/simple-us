...
class ListItemText(ReactWidget):
    ...
    primary_typography_props = Dict(default_value=None, allow_none=True).tag(sync=True)
    ...
    secondary_typography_props = Dict(default_value=None, allow_none=True).tag(sync=True)


__all__ = ['ListItemText']
